...
<form action="?page=savereguser" method="post" name="form1" target="_self">
    ...
    <div class="cleaner_h5"></div>
    <input type="search" style="width:90%;" id="nama" name="nama" placeholder="Nama" value="" required />
    <div class="cleaner_h10"></div>
  
    <label for="menu">Usia</label>
    <div class="cleaner_h5"></div>
    <input type="number" style="width:90%;" id="usia" name="usia" placeholder="usia" value="" required />
    <div class="cleaner_h10"></div>
  
    <label for="menu">Alamat</label>
    <div class="cleaner_h5"></div>
    <input type="search" style="width:90%;" id="alamat" name="alamat" placeholder="Alamat" value="" required />
    <div class="cleaner_h10"></div>
